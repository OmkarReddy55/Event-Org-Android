...
public class dance_upload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dance_upload);

        // Initialize Firebase storage and database references
        storageReference = FirebaseStorage.getInstance().getReference().child("dance");
        wrappersReference = FirebaseDatabase.getInstance().getReference("dance");
    ...
    private void uploadWrapper() {
        ...
        if (imageUri != null) {
            StorageReference fileReference = storageReference.child("dance").child(title + System.currentTimeMillis() + ".jpg");
            ...
            fileReference.putFile(imageUri)
                    .addOnSuccessListener(taskSnapshot -> {
                        fileReference.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            Toast.makeText(dance_upload.this, "Event added successfully", Toast.LENGTH_SHORT).show();
                            finish();
                        });
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(dance_upload.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        } else {
